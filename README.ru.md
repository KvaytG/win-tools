...
## ❗ Важные замечания
* Производительность проверялась только на Windows 10 и Windows 11.
...
## 🙏 Благодарности
Особая благодарность **adasdead** за разработку нативных DLL, благодаря которым проект стал возможен.

## 📜 Лицензия
Лицензировано под **[MIT](LICENSE.txt)**.

Проект использует открытые компоненты. Для информации о лицензиях смотрите **[pom.xml](pom.xml)** и официальные сайты зависимостей.
